...
{
    /// <summary>
    /// The parsed representation of a SeleniumUI source document.
    /// </summary>
    public abstract class SeleniumUISyntaxTree : SyntaxTree
    {
        internal static readonly SyntaxTree Dummy = new DummySyntaxTree();
        public override Language Language => SeleniumUILanguage.Instance;
        /// <summary>
        /// The options used by the parser to produce the syntax tree.
        /// </summary>
        public new abstract SeleniumUIParseOptions Options { get; }
        /// <summary>
        /// Gets the root node of the syntax tree.
        /// </summary>
        public new abstract SeleniumUISyntaxNode GetRoot(CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets the root node of the syntax tree if it is already available.
        /// </summary>
        public abstract bool TryGetRoot(out SeleniumUISyntaxNode root);
        /// <summary>
        ...
        /// </remarks>
        public new virtual Task<SeleniumUISyntaxNode> GetRootAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            SeleniumUISyntaxNode node;
        ...
        private SyntaxTree WithChanges(SourceText newText, IReadOnlyList<TextChangeRange> changes)
        {
            ...
            using (var parser = SeleniumUILanguage.Instance.SyntaxFactory.MakeParser(newText, this.Options, oldTree?.GetRoot(), changes))
            {
        ...
        public abstract SeleniumUISyntaxTree WithRootAndOptions(SyntaxNode root, ParseOptions options);
        public abstract SeleniumUISyntaxTree WithFilePath(string path);
        #region Factories
        /// <summary>
        /// Creates a new syntax tree from a syntax node.
        /// </summary>
        public static SeleniumUISyntaxTree Create(SeleniumUISyntaxNode root, SeleniumUIParseOptions options = null, string path = "", Encoding encoding = null)
        {
            if (root == null)
            {
            ...
            return new ParsedSyntaxTree(
                ...
                path: path,
                options: options ?? SeleniumUIParseOptions.Default,
                root: root,
        ...
        internal static SeleniumUISyntaxTree CreateForDebugger(SeleniumUISyntaxNode root, SourceText text)
        {
        ...
        /// <summary>
        /// <para>
        /// Internal helper for <see cref="SeleniumUISyntaxNode"/> class to create a new syntax tree rooted at the given root node.
        /// This method does not create a clone of the given root, but instead preserves it's reference identity.
        /// </para>
        /// <para>NOTE: This method is only intended to be used from <see cref="SeleniumUISyntaxNode.SyntaxTree"/> property.</para>
        /// <para>NOTE: Do not use this method elsewhere, instead use <see cref="Create(SeleniumUISyntaxNode, SeleniumUIParseOptions, string, Encoding)"/> method for creating a syntax tree.</para>
        /// </summary>
        internal static SeleniumUISyntaxTree CreateWithoutClone(SeleniumUISyntaxNode root)
        {
            Debug.Assert(root != null);
            return new ParsedSyntaxTree(
                textOpt: null,
                ...
                checksumAlgorithm: SourceHashAlgorithm.Sha1,
                path: "",
                options: SeleniumUIParseOptions.Default,
                root: root,
        ...
        /// </summary>
        public static SeleniumUISyntaxTree ParseText(
            string text,
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            options = options ?? SeleniumUIParseOptions.Default;
            using (var parser = SeleniumUILanguage.Instance.SyntaxFactory.MakeParser(text, options, oldTree: null, changes: null))
            {
                var compilationUnit = (MainSyntax)parser.Parse().CreateRed();
        ...
        {
            public DebuggerSyntaxTree(SeleniumUISyntaxNode root, SourceText text)
                : base(
                    text,
                    text.Encoding,
        ...
        private sealed class DummySyntaxTree : SeleniumUISyntaxTree
        {
            private readonly MainSyntax _node;
            public DummySyntaxTree()
            {
                _node = new MainSyntax(SeleniumUILanguage.Instance.InternalSyntaxFactory.Main(null, null, true), this, 0);
            }
            ...
            public override SeleniumUIParseOptions Options
            {
                get { return SeleniumUIParseOptions.Default; }
            }
            public override string FilePath
            {
                get { return string.Empty; }
            }
            public override SeleniumUISyntaxNode GetRoot(CancellationToken cancellationToken)
            {
                return _node;
            }
            public override bool TryGetRoot(out SeleniumUISyntaxNode root)
            {
                root = _node;
                return true;
            }
            ...
            public override SeleniumUISyntaxTree WithRootAndOptions(SyntaxNode root, ParseOptions options)
            {
                return SeleniumUILanguage.Instance.SyntaxFactory.SyntaxTree(root, options: (SeleniumUIParseOptions)options, path: FilePath, encoding: null);
            }
            public override SeleniumUISyntaxTree WithFilePath(string path)
            {
                return SeleniumUILanguage.Instance.SyntaxFactory.SyntaxTree(_node, options: this.Options, path: path, encoding: null);
            }
        }
        private class ParsedSyntaxTree : SeleniumUISyntaxTree
        {
            private readonly SeleniumUIParseOptions _options;
            private readonly string _path;
            private readonly SeleniumUISyntaxNode _root;
            private readonly bool _hasCompilationUnitRoot;
            private readonly Encoding _encodingOpt;
            private readonly SourceHashAlgorithm _checksumAlgorithm;
            private SourceText _lazyText;
            internal ParsedSyntaxTree(SourceText textOpt, Encoding encodingOpt, SourceHashAlgorithm checksumAlgorithm, string path, SeleniumUIParseOptions options, SeleniumUISyntaxNode root, DirectiveStack directives, bool cloneRoot = true)
            {
                Debug.Assert(root != null);
                ...
                _hasCompilationUnitRoot = root.Kind == SeleniumUISyntaxKind.Main;
