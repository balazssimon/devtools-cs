...
{
    /// <summary>
    /// The parsed representation of a SeleniumUserInterface source document.
    /// </summary>
    public abstract class SeleniumUserInterfaceSyntaxTree : SyntaxTree
    {
        internal static readonly SyntaxTree Dummy = new DummySyntaxTree();
        public override Language Language => SeleniumUserInterfaceLanguage.Instance;
        /// <summary>
        /// The options used by the parser to produce the syntax tree.
        /// </summary>
        public new abstract SeleniumUserInterfaceParseOptions Options { get; }
        /// <summary>
        /// Gets the root node of the syntax tree.
        /// </summary>
        public new abstract SeleniumUserInterfaceSyntaxNode GetRoot(CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets the root node of the syntax tree if it is already available.
        /// </summary>
        public abstract bool TryGetRoot(out SeleniumUserInterfaceSyntaxNode root);
        /// <summary>
        ...
        /// </remarks>
        public new virtual Task<SeleniumUserInterfaceSyntaxNode> GetRootAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            SeleniumUserInterfaceSyntaxNode node;
        ...
        private SyntaxTree WithChanges(SourceText newText, IReadOnlyList<TextChangeRange> changes)
        {
            ...
            using (var parser = SeleniumUserInterfaceLanguage.Instance.SyntaxFactory.MakeParser(newText, this.Options, oldTree?.GetRoot(), changes))
            {
        ...
        public abstract SeleniumUserInterfaceSyntaxTree WithRootAndOptions(SyntaxNode root, ParseOptions options);
        public abstract SeleniumUserInterfaceSyntaxTree WithFilePath(string path);
        #region Factories
        /// <summary>
        /// Creates a new syntax tree from a syntax node.
        /// </summary>
        public static SeleniumUserInterfaceSyntaxTree Create(SeleniumUserInterfaceSyntaxNode root, SeleniumUserInterfaceParseOptions options = null, string path = "", Encoding encoding = null)
        {
            if (root == null)
            {
            ...
            return new ParsedSyntaxTree(
                ...
                path: path,
                options: options ?? SeleniumUserInterfaceParseOptions.Default,
                root: root,
        ...
        internal static SeleniumUserInterfaceSyntaxTree CreateForDebugger(SeleniumUserInterfaceSyntaxNode root, SourceText text)
        {
        ...
        /// <summary>
        /// <para>
        /// Internal helper for <see cref="SeleniumUserInterfaceSyntaxNode"/> class to create a new syntax tree rooted at the given root node.
        /// This method does not create a clone of the given root, but instead preserves it's reference identity.
        /// </para>
        /// <para>NOTE: This method is only intended to be used from <see cref="SeleniumUserInterfaceSyntaxNode.SyntaxTree"/> property.</para>
        /// <para>NOTE: Do not use this method elsewhere, instead use <see cref="Create(SeleniumUserInterfaceSyntaxNode, SeleniumUserInterfaceParseOptions, string, Encoding)"/> method for creating a syntax tree.</para>
        /// </summary>
        internal static SeleniumUserInterfaceSyntaxTree CreateWithoutClone(SeleniumUserInterfaceSyntaxNode root)
        {
            Debug.Assert(root != null);
            return new ParsedSyntaxTree(
                textOpt: null,
                ...
                checksumAlgorithm: SourceHashAlgorithm.Sha1,
                path: "",
                options: SeleniumUserInterfaceParseOptions.Default,
                root: root,
        ...
        /// </summary>
        public static SeleniumUserInterfaceSyntaxTree ParseText(
            string text,
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            options = options ?? SeleniumUserInterfaceParseOptions.Default;
            using (var parser = SeleniumUserInterfaceLanguage.Instance.SyntaxFactory.MakeParser(text, options, oldTree: null, changes: null))
            {
                var compilationUnit = (MainSyntax)parser.Parse().CreateRed();
        ...
        {
            public DebuggerSyntaxTree(SeleniumUserInterfaceSyntaxNode root, SourceText text)
                : base(
                    text,
                    text.Encoding,
        ...
        private sealed class DummySyntaxTree : SeleniumUserInterfaceSyntaxTree
        {
            private readonly MainSyntax _node;
            public DummySyntaxTree()
            {
                _node = new MainSyntax(SeleniumUserInterfaceLanguage.Instance.InternalSyntaxFactory.Main(null, null, true), this, 0);
            }
            ...
            public override SeleniumUserInterfaceParseOptions Options
            {
                get { return SeleniumUserInterfaceParseOptions.Default; }
            }
            public override string FilePath
            {
                get { return string.Empty; }
            }
            public override SeleniumUserInterfaceSyntaxNode GetRoot(CancellationToken cancellationToken)
            {
                return _node;
            }
            public override bool TryGetRoot(out SeleniumUserInterfaceSyntaxNode root)
            {
                root = _node;
                return true;
            }
            ...
            public override SeleniumUserInterfaceSyntaxTree WithRootAndOptions(SyntaxNode root, ParseOptions options)
            {
                return SeleniumUserInterfaceLanguage.Instance.SyntaxFactory.SyntaxTree(root, options: (SeleniumUserInterfaceParseOptions)options, path: FilePath, encoding: null);
            }
            public override SeleniumUserInterfaceSyntaxTree WithFilePath(string path)
            {
                return SeleniumUserInterfaceLanguage.Instance.SyntaxFactory.SyntaxTree(_node, options: this.Options, path: path, encoding: null);
            }
        }
        private class ParsedSyntaxTree : SeleniumUserInterfaceSyntaxTree
        {
            private readonly SeleniumUserInterfaceParseOptions _options;
            private readonly string _path;
            private readonly SeleniumUserInterfaceSyntaxNode _root;
            private readonly bool _hasCompilationUnitRoot;
            private readonly Encoding _encodingOpt;
            private readonly SourceHashAlgorithm _checksumAlgorithm;
            private SourceText _lazyText;
            internal ParsedSyntaxTree(SourceText textOpt, Encoding encodingOpt, SourceHashAlgorithm checksumAlgorithm, string path, SeleniumUserInterfaceParseOptions options, SeleniumUserInterfaceSyntaxNode root, DirectiveStack directives, bool cloneRoot = true)
            {
                Debug.Assert(root != null);
                ...
                _hasCompilationUnitRoot = root.Kind == SeleniumUserInterfaceSyntaxKind.Main;
            ...
            public override SeleniumUserInterfaceSyntaxTree WithRootAndOptions(SyntaxNode root, ParseOptions options)
            {
                ...
                return new ParsedSyntaxTree(
                    ...
                    (SeleniumUserInterfaceSyntaxNode)root,
                    this.GetDirectives());
            }
            public override SeleniumUserInterfaceSyntaxTree WithFilePath(string path)
            {
